...
function Features() {
  return (
    <div className="bg-lm-primary dark:bg-dm-secondary">
      <div className="mx-auto max-w-7xl py-16 px-4 sm:px-6 lg:grid lg:grid-cols-3 lg:gap-x-8 lg:py-24 lg:px-8">
        <div>
          ...
          <p className="mt-4 text-lg text-lm-secondary-text dark:text-dm-secondary-text">
              ...
              <div key={feature.name} className="relative">
                <dt>
                  <CheckIcon
                    ...
                    aria-hidden="true"
                  />
                  <p className="ml-9 text-lg font-medium leading-6 text-lm-third-text dark:text-dm-primary-text">
                    {feature.name}
                  </p>
                </dt>
                <dd className="mt-2 ml-9 text-base text-lm-primary-text">
                  {feature.description}
                </dd>
              </div>
            ))}
